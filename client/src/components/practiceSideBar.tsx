...
import { AuthContextType } from '../routes/__root';

export function PracticeSidebar({ user }: { user: AuthContextType['user'] }) {
  return (
        ...
        <div className='flex items-center gap-3 mb-4'>
          <div className='h-12 w-12 bg-primary/10 rounded-full flex items-center justify-center'>
            {!user?.profilePicUrl ? (
              ...
              <img src={user?.profilePicUrl} className='h-6 w-6 rounded-full' />
            )}
          </div>
          <div>
