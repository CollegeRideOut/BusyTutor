...
test('NotOperator', () => {
  const tests = [
    {
      exp: evalChunkTestHelper(
        luaparser.parse('return not true', { locations: true }),
        new Lua_Environment(),
      ),
      value: false,
    },
    ...
    {
      exp: evalChunkTestHelper(
        luaparser.parse('return not 5', { locations: true }),
        new Lua_Environment(),
      ),
      value: false,
    },
    ...
    {
      exp: evalChunkTestHelper(
        luaparser.parse('return not nil', { locations: true }),
        new Lua_Environment(),
      ),
      value: true,
    },
...
describe('Minues operator', () => {
  test('Integer', () => {
    const tests = [
      {
        exp: evalChunkTestHelper(
          luaparser.parse('return -2', { locations: true }),
          new Lua_Environment(),
        ),
        value: -2,
      },
      {
        exp: evalChunkTestHelper(
          luaparser.parse('return -10', { locations: true }),
          new Lua_Environment(),
        ),
        value: -10,
      },
...
describe('ReturnStatement', () => {
  test('One argument', () => {
    const tests = [
      ...
      {
        exp: evalChunkTestHelper(
          luaparser.parse('return 12', { locations: true }),
          new Lua_Environment(),
        ),
        value: 12,
      },
      {
        exp: evalChunkTestHelper(
          luaparser.parse('return 14', { locations: true }),
          new Lua_Environment(),
        ),
        value: 14,
      },
      {
        exp: evalChunkTestHelper(
          luaparser.parse('return 20', { locations: true }),
          new Lua_Environment(),
        ),
        value: 20,
      },
  ...
  test('Two argument', () => {
    const tests = [
      ...
      {
        exp: evalChunkTestHelper(
          luaparser.parse('return 12, 30', { locations: true }),
          new Lua_Environment(),
        ),
        value: [12, 30],
      },
      {
        exp: evalChunkTestHelper(
          luaparser.parse('return 14, 50', { locations: true }),
          new Lua_Environment(),
        ),
        value: [14, 50],
      },
      {
        exp: evalChunkTestHelper(
          luaparser.parse('return 20, 11', { locations: true }),
          new Lua_Environment(),
        ),
        value: [20, 11],
      },
...
describe('Errors', () => {
  test('types', () => {
    const tests = [
      ...
      {
        exp: evalChunkTestHelper(
          luaparser.parse('return -true', { locations: true }),
          new Lua_Environment(),
        ),
        value: 5,
      },
